  ...
  <div class="Header-Container" v-if="user.role === 'student'">
    ...
    <div class="Header-Item" style="margin-right: 24px" ref="mineContainer">
      <div class="Multiple-Header-Item-Container">
        ...
        <el-button
            plain
            :type="route.path.startsWith('/portal/learning')?'primary':'default'"
        ...
        <el-popover placement="bottom-start">
          <template #reference>
            <el-badge :value="assignmentNum + messageNum" style="margin-right: 24px">
              <el-button
                  :type="route.path.startsWith('/portal') && !route.path.startsWith('/portal/learning')?'primary':'default'"
                  plain>
                <el-link type="primary"
                         style="
                       font-size: 18px;
...
const handleToMyAcademy = () => {
  if(route.path.startsWith('/portal/traces')){
    ElNotification({
      message: '你已经在我的学堂啦',
      type: 'success',
      offset: 64,
  ...
  router.push("/portal/traces")
}
const handleToMainPage = () => {
  if(route.path === '/portal/learning'){
    ElNotification({
      message: '你已经在首页啦',
      type: 'success',
      offset: 64,
