...
<template>
  <div class="chat-view">
    <div class="chat-header">
      <el-text size="large" style="font-weight: bold; font-size: 20px">智能问答</el-text>
    </div>
    ...
    <div class="chat-input-area">
      <el-input v-model="inputText" placeholder="请输入你的问题..." @keyup.enter="sendMessage" size="large" clearable>
        <template #append>
